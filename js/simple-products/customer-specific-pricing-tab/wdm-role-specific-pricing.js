...
// Add the elements for role specific tab.
    ...
    var i = jQuery( '#wdm_role_specific_pricing_tbody tr' ).length + 1;
    ...
    jQuery('body').on('focus', '#wdm_role_specific_pricing_tbody .wdm_price:last', function() {
        jQuery( this ).closest('tbody').find( '#wdm_add_new_role_price_pair' ).click();
    });
